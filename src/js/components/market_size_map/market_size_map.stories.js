...
storiesOf("MarketSizeMap", module)
  ...
  .add("Portland (Polygon and MultiPolygon)", () => (
    <div style={{ width: 870, height: 452, margin: "80px auto" }}>
      <MarketSizeMap {...props_portland} />
    </div>
  ))
  .add("Bermuda Triangle (with holes)", () => (
    <div style={{ width: 870, height: 452, margin: "80px auto" }}>
      <MarketSizeMap {...props_bermuda} />
    </div>
  ));
