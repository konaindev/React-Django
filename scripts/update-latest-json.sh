...
heroku run python manage.py dumpdata --natural-foreign --natural-primary projects email_app crm analytics auth users contenttypes geo.address > data/dumped/latest.json
