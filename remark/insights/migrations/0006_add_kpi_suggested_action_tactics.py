    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(max_length=160)),
                ('tactics', models.ManyToManyField(blank=True, through='insights.ActionAndTacticsJunction', to='insights.SuggestedActionTactic')),
            ],
        ),
        migrations.CreateModel(
            name='KPI',
            fields=[
                ...
                ('name', models.TextField(choices=[('leased', 'Leased'), ('retention', 'Retention'), ('occupied', 'Occupied'), ('app', 'Lease Applications / Volume of APP'), ('cds', 'Cancellations & Denials'), ('renew', 'Notices to Renew'), ('vacate', 'Notices to Vacate'), ('move_ins', 'Move Ins'), ('move_outs', 'Move Outs'), ('investment', 'Campaign Investment'), ('estimated_revenue_gain', 'Estimated Revenue Change'), ('romi', 'Campaign Return on Marketing Investment'), ('delta_leases', 'Leased Unit Change'), ('acq_investment', 'Acquisition Investment'), ('estimated_acq_revenue_gain', 'Est. Acquired Leasing Revenue'), ('acq_romi', 'Acquisition ROMI'), ('lease_renewals', 'Lease Renewals'), ('ret_investment', 'Retention Investment'), ('estimated_ret_revenue_gain', 'Est. Retained Leasing Revenue'), ('ret_romi', 'Retention ROMI'), ('usv_exe', 'USV > EXE'), ('lease_cd_rate', 'Cancellation & Denial Rate'), ('lowest_monthly_rent', 'Cost Per EXE / Lowest Monthly Rent'), ('usv', 'Volume of USV'), ('inq', 'Volume of INQ'), ('tou', 'Volume of TOU'), ('exe', 'Volume of EXE'), ('usv_inq', 'USV > INQ'), ('inq_tou', 'INQ > TOU'), ('tou_app', 'TOU > APP'), ('app_exe', 'APP > EXE'), ('cost_per_usv', 'Cost per USV'), ('cost_per_inq', 'Cost per INQ'), ('cost_per_tou', 'Cost per TOU'), ('cost_per_app', 'Cost per APP'), ('cost_per_exe', 'Cost per EXE')], help_text='KPI name, user cannot edit')),
        ...
        migrations.AddField(
            model_name='actionandtacticsjunction',
            name='suggested_action',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='insights.SuggestedAction'),
        ),
        migrations.AddField(
            model_name='actionandtacticsjunction',
            name='tactic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='insights.SuggestedActionTactic'),
        ),
    ]
