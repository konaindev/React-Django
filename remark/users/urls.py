...
from .views import ChangePasswordView, ResetPasswordView, ResetPasswordConfirmView, CreatePasswordView, PasswordRulesView, CompleteAccountView
...
urlpatterns = [
    ...
    path("users/reset-password-confirm/", ResetPasswordConfirmView.as_view(), name="users_reset_password_confirm"),
