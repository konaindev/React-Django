...
class BaselinePerfImporter(RemarkablyExcelImporter):
    ...
    PERIOD_SCHEMA = {
        ...
        "lease_renewal_notices": _loc("I", dt=DataType.NUMERIC),
        "lease_renewals": _loc("H", dt=DataType.NUMERIC),
        "lease_vacation_notices": _loc("J", dt=DataType.NUMERIC),
        "occupiable_units_start": _loc("L", dt=DataType.NUMERIC),
        "occupied_units_start": _loc("K", dt=DataType.NUMERIC),
        "move_ins": _loc("M", dt=DataType.NUMERIC),
        "move_outs": _loc("N", dt=DataType.NUMERIC),
        "acq_reputation_building": _loc("R", dt=DataType.NUMERIC),
        "acq_demand_creation": _loc("S", dt=DataType.NUMERIC),
        "acq_leasing_enablement": _loc("T", dt=DataType.NUMERIC),
        "acq_market_intelligence": _loc("U", dt=DataType.NUMERIC),
        "ret_reputation_building": _loc("V", dt=DataType.NUMERIC),
        "ret_demand_creation": _loc("W", dt=DataType.NUMERIC),
        "ret_leasing_enablement": _loc("X", dt=DataType.NUMERIC),
        "ret_market_intelligence": _loc("Y", dt=DataType.NUMERIC),
        "usvs": _loc("O", dt=DataType.NUMERIC),
        "inquiries": _loc("P", dt=DataType.NUMERIC),
        "tours": _loc("Q", dt=DataType.NUMERIC),
    }
