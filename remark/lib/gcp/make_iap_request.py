...
def make_iap_request(url, client_id, method='GET', **kwargs):
    ...
    # Construct OAuth 2.0 service account credentials.
    service_account_info = json.loads(GCLOUD_SERVICE_KEY)
    service_account_credentials = service_account.IDTokenCredentials.from_service_account_info(service_account_info, target_audience=client_id)
